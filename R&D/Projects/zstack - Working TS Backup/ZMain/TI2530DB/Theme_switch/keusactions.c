...
void buttonPressAction(uint8 buttonId)
{
    ...
    if (debugModeActive)
    {
        ...
        case BUTTON1_ID:
            ...
            osal_set_event(KEUS_taskID, KEUS_APP_EVT1);
            break;

        case BUTTON2_ID:
            //keusAppEvents |= KEUS_APP_EVT2;
            osal_set_event(KEUS_taskID, KEUS_APP_EVT2);
            break;

        case BUTTON3_ID:
            //keusAppEvents |= KEUS_APP_EVT3;
            osal_set_event(KEUS_taskID, KEUS_APP_EVT3);
            break;

        case BUTTON4_ID:
            //keusAppEvents |= KEUS_APP_EVT4;
            osal_set_event(KEUS_taskID, KEUS_APP_EVT4);
            break;
        default:
            break;
        }
